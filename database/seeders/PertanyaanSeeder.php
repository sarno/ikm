    ...
    public function run(): void
    {
        ...
        if (! $settingWeb) {
            ...
            $settingWeb = SettingWeb::create([
                ...
                'alamat' => 'Mezzeh, Eastern Villas, al-Madina al-Munawara Street, opposite to Omar bin Abdul Aziz Mosque, Block 270/A Building No.26, P.O.BOX 3530, Damascus - SYRIA',
                'footer_struk' => '-',
                'token' => '-',
                'is_perm' => 1,
                'bulan' => 12,
        ...
        if ($pelayanans->isEmpty()) {
            ...
            $pelayanan = Pelayanan::create([
                ...
                'description' => 'Pelayanan terkait urusan konsuler seperti paspor, visa, dan bantuan warga negara.',
                'logo' => null,
            ]);
            ...
            $pelayanan = Pelayanan::create([
                ...
                'description' => 'Pelayanan terkait perlindungan warga negara Indonesia di luar negeri.',
                'logo' => null,
            ]);
